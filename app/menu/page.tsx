...
export const metadata: Metadata = {
  title: "La Carta Náutica — Puerto, Punta del Este",
  description:
    "La Carta Náutica de Puerto — pescados del día, mariscos, pastas marineras, parrilla y la barra. Filtrá por Almuerzo, Cena o Bar.",
};
